...
if args.function == 'pretrain':
    ...
    raw_corpus = open(args.finetune_corpus_path).read()
    dataset = dataset.NameDataset(pretrain_dataset, raw_corpus)
    ...
    elif args.reading_params_path is not None:
        ### F
    ...
    trainer = trainer.Trainer(model, dataset, None, tconfig)
    trainer.train()
